...
pub fn drop_piece(board: &mut Vec<Vec<i32>>, row: usize, col: usize, player: i32) {
    board[row][col] = player;
}

pub fn is_valid_location(board: &mut Vec<Vec<i32>>, col: usize) -> bool{
	board[0][col] == 0
}


pub fn get_valid_locations(board: &mut Vec<Vec<i32>>) -> Vec<usize>{
...
pub fn winning_move(board: &Vec<Vec<i32>>, piece: i32) -> bool{
...
pub fn is_terminal_node(board: &mut Vec<Vec<i32>>) -> bool {
...
pub fn evaluate_window(window: &[i32], piece: i32) -> i32 {
    let mut score = 0;
...
pub fn score_position(board: &Vec<Vec<i32>>, piece: i32) -> i32 {
    let mut score = 0;
    let COLUMN_COUNT = board[0].len();
    let ROW_COUNT = board.len();
...
pub fn random_choice(items: &Vec<usize>) -> Option<&usize> {
    let mut rng = rand::thread_rng();
    items.choose(&mut rng)
}

pub fn minimax(board: &mut Vec<Vec<i32>>, depth: i32, alpha: i32, beta: i32, maximizing_player: bool) -> (Option<usize>, i32) {
